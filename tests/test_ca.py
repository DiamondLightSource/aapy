...
CA_EVENT_2D = {"value": [1.1, 2, 3], "secs": 10, "nano": 21e7, "sevr": 1}
...
def test_CaFetcher_get_values_calls_client_get_once_if_response_less_than_count(
    ca_fetcher, event_1d, data_1d
):
...
def test_CaFetcher_get_values_calls_client_get_twice_if_count_exceeds_10000(
    ca_fetcher, event_1d, event_1d_alt, data_2_events
):
