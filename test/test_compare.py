from aa import compare, utils
import numpy


ONE_EVENT_DATA = utils.ArchiveData('dummy',
                                   numpy.array((1,)),
                                   numpy.array((2,)),
                                   numpy.array((1,)))
HIGH_SEV_DATA = utils.ArchiveData('dummy',
                                  numpy.array((1,)),
                                  numpy.array((2,)),
                                  numpy.array((4,)))
TWO_EVENT_DATA = utils.ArchiveData('dummy',
                                   numpy.array((1,2)),
                                   numpy.array((2,3)),
                                   numpy.array((1,0)))
DUPLICATE_DATA = utils.ArchiveData('dummy',
                                   numpy.array((1,1)),
                                   numpy.array((2,2)),
                                   numpy.array((1,1)))
TWO_EVENT_WITH_DUPLICATE_DATA = utils.ArchiveData('dummy',
                                                  numpy.array((1,1,2)),
                                                  numpy.array((2,2,3)),
                                                  numpy.array((1,1,0)))
...
def test_compare_archive_data_locates_high_sev_data():
    ...
    high_sev_event = utils.ArchiveEvent('dummy', 1, 2, 4)
...
def test_compare_archive_data_locates_duplicate_event():
    ...
    assert diff._duplicates[diff.RIGHT] == [utils.ArchiveEvent('dummy', 1, 2, 1)]
...
def test_compare_archive_data_locates_duplicate_event_and_extra_event():
    ...
    assert diff._duplicates[diff.LEFT] == []
    assert diff._duplicates[diff.RIGHT] == [utils.ArchiveEvent('dummy', 1, 2, 1)]
    assert diff._extra[diff.LEFT] == [utils.ArchiveEvent('dummy', 2, 3, 0)]
    assert diff._extra[diff.RIGHT] == []
...
def test_compare_archive_data_matches_two_events_with_one_duplicate():
    ...
    assert diff._duplicates[diff.LEFT] == [utils.ArchiveEvent('dummy', 1, 2, 1)]
